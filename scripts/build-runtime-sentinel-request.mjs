...
const evidence = JSON.parse(await readFile("evidence/warm-runner-real-webcontainer.json", "utf8"));
...
const body = {
  ...
  sentinel_type: "WARM_RUNNER_REAL_WEBCONTAINER",
  capability_key: "stackblitz_warm_runner_v2",
  source_commit: sha,
  run_id: runId,
...
await writeFile("evidence/runtime-sentinel-request.json", JSON.stringify(body, null, 2) + "\n", "utf8");
