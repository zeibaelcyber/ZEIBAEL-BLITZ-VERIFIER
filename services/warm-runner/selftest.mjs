...
}catch(e){console.log("BLITZ_WARM_RUNNER_SELFTEST="+JSON.stringify({schema:"zeibael.blitz.warm-runner-selftest.v2",ok:false,error:String(e?.stack||e),logs,live_order_enabled:false}));process.exitCode=1}finally{child.kill("SIGKILL")}
